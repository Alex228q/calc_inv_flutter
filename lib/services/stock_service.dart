...
class StockService {
  static const List<Map<String, dynamic>> _stocksInfo = [
    ...
    {"ticker": "MDMG", "name": "Мать и дитя", "lotSize": "1", "targetPercentage": 7},
    ...
    {"ticker": "LSNGP", "name": "Ленэнерго", "lotSize": "10", "targetPercentage": 7},
    {
      "ticker": "SBERP",
      "name": "Сбербанк",
      "lotSize": "1",
    ...
    },
  {
    ...
    {"ticker": "T", "name": "Т-Технологии", "lotSize": "1", "targetPercentage": 7},
    {"ticker": "TATNP", "name": "Татнефть", "lotSize": "1", "targetPercentage": 7},
    
    {"ticker": "PHOR", "name": "Фосагро", "lotSize": "1", "targetPercentage": 7},
    {"ticker": "YDEX", "name": "Yandex", "lotSize": "1", "targetPercentage": 8},
